  ...
  <tr>
	<td>
	  <table width='100%' cellspacing='1' cellpadding='5' border=0>
		...
		{order->order_list status="pros" not_status="send" first=$smarty.get.first length=$length start_date=$from end_date=$to}
		...
		{/if}
		  ...
		  <td class='admin_info' align="right">
		  	<a href='index.php?process=processed&order_id={$shop_order.order_id}'>Click to View then Send</a> 
