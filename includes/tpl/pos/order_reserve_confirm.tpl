...
<div class="help">{!pos_checkdetails2!}</div>
 <table  width='100%' border='0' cellspacing='0' cellpadding='1'
style='padding:5px;'>
<tr>
 <tr><td class='user_address_td'>{user->user_firstname} {user->user_lastname}</td></tr>
...
<tr><td class='user_address_td'>{include file="countries.tpl" code=$user->user_country}</td></tr>
