...
<tr>
  ...
  <td class='TblHigher'><input type='text' name='user_addresse' size='30'  maxlength='75' value='{$user_data.user_addresse}'><span class='error'>{$user_errors.user_addresse}</span></td>
</tr>
<tr>
  <td class='TblLower'> {!address!} 2 </td>
  <td class='TblHigher'><input type='text' name='user_addresse1' size='30'  maxlength='75' value='{$user_data.user_addresse1}'><span class='error'>{$user_errors.user_addresse1}</span></td>
</tr>
<tr>
