  ...
  <tr>
  	<td colspan="2">
  	  <table width='100%' bgcolor="lightgrey">
  		<tr>
  		  <td width='33%' align="left"><a href="index.php?process=paid">Click to go back to list of UnProcessed Orders</a></td>
  		  <td width='34%' align="center"><a href='javascript:if(confirm("Processed Order? The Order ID and Ticket IDs been noted?")){literal}{location.href="index.php?process=paid&order_id={/literal}{$shop_order.order_id}{literal}&action=change_status";}{/literal}'>
      				Click To Finish Processing!</a></td>
  		  <td width='33%' align="right"><a href="index.php?process=paid&order_id={$next_order_id}">Next Unprocessed Paid Order</a></td>
		</tr>
	  </table>
	</td>
  </tr>
