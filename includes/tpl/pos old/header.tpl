  ...
  <table>
	<tr>
  	<td width="33%" align="center">
	  	<a class="shop_link" style="font-size:16px;" href="index.php?action=home">Home Page</a>
	</td>
	<td width="34%" align="center">
		<a class="shop_link" style="font-size:16px;" href="index.php?process=on">Process Tickets</a>
    </td>
	<td width="33%" align="center">
		<a class="shop_link" style="font-size:16px;" href="index.php?action=book_tickets">Book Tickets</a>
    </td>
    </tr>
  </table>
  </td>
