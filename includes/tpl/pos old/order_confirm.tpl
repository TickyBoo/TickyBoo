...
<tr><td class='title'  align='center' colspan='4'>{fr}Commande Nr.{/fr}
    {#order_id#} {$order_id}<br>
	<div class="help">Check the details, If cash or check Click "Confirm and Print"<br>
		If you have to pay with Credit/Debit Card click the "PayNow" button and Follow the Paypal instructions.</div> </td></tr>
