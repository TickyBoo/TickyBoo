...
<page style="font-size: 10pt">
	...
	<br>
	<table align="center" style="border: solid 1px #000000;"><tr><td style=" border-top: dotted 4mm #000077;	border-right: dotted 3mm #007700;	border-bottom: dotted 2mm #770000;	border-left:	dotted 1mm #007777;	padding: 2mm 4mm 6mm 8mm; width: 100mm; background: #FFDDDD">Coucou ! ceci est un border dotted</td></tr></table>
	<br>
	<table align="center" style="border: solid 1px #000000;"><tr><td style=" border-top: dashed 4mm #000077;	border-right: dashed 3mm #007700;	border-bottom: dashed 2mm #770000;	border-left:	dashed 1mm #007777;	padding: 2mm 4mm 6mm 8mm; width: 100mm; background: #FFDDDD">Coucou ! ceci est un border dashed</td></tr></table>
	<br>
<?php $back = 'background-image: url(./res/off.png); background-position: left top; background-repeat: repeat; '; ?>
	...
	<br>
	<table style="border: solid 2px #550000; background: #000022 url(./res/logoHTMLtoPDF.gif) center center no-repeat; color: #FFFFFF;">
		<tr >
