...
global $_SHOP;
 ...
 function admin_list (){
  ...
  while($row=shopDB::fetch_assoc($res)){
    ...
    echo "<a class='link' href='{$_SERVER['PHP_SELF']}?action=edit&admin_id={$row['admin_id']}'><img src=\"".$_SHOP->root."images/edit.gif\" border='0' alt='".con("edit")."' title='".con("edit")."'></a>\n";
    echo "<a class='link' href='javascript:if(confirm(\"".con("delete_item")."\")){location.href=\"{$_SERVER['PHP_SELF']}?action=remove&admin_id={$row['admin_id']}\";}'><img src=\"".$_SHOP->root."images/trash.png\" border='0' alt='".con("remove")."' title='".con("remove")."'></a>\n";
    echo "</td></tr>";
    $alt=($alt+1)%2;
  }
  echo "</table>\n";
