  ...
  <tr>
  	<td colspan="2">
  	  <table width='100%' bgcolor="lightgrey">
  		<tr>
  		  <td width='33%' align="left"><a href="view.php?process=paid">{!pos_gotounprocessed!}</a></td>
  		  <td width='34%' align="center"><a href='javascript:if(confirm("{!pos_processorder!}")){literal}{location.href="view.php?process=paid&order_id={/literal}{$shop_order.order_id}{literal}&action=change_status";}{/literal}'>
      				{!pos_clicktoproc!}</a></td>
  		  <td width='33%' align="right"><a href="view.php?process=paid&order_id={$next_order_id}">{!pos_nextunprocessed!}</a></td>
		</tr>
	  </table>
	</td>
  </tr>
