   		...
   		<form action='index.php' method='post'>
   			<table  cellpadding='5' width='100%' border='0'>
   				<tr>
					...
					<td class='title' colspan='{$shop_discounts_count+1}' valign='top'> 
						{$shop_category.event_name} - {$shop_category.category_name}
					</td>
				</tr>
				<tr>
					<td class='discount_item' valign='top'>
				   		{!place_nr!}
		   			</td>
		   			<td colspan='{$shop_discounts_count+1}'>
		   			</td>
		   		</tr>
    			...
    			<tr>
    				...
    				<td class='discount_value'>
						<label>
							<input style='border:0px;' type='radio' name='discount[{$places_id[i]}]' value='0' checked="" />  
								{!normal!}
						</label>
					</td>
					...
					{section name='d' loop=$shop_discounts}
      				<td class='discount_value'>
		  				<label>
			  				<input style='border:0px;' type='radio' name='discount[{$places_id[i]}]' value='{$shop_discounts[d].discount_id}' />
